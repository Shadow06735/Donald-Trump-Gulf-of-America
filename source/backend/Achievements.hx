...
class Achievements {
	public static function init()
	{
		...
		createAchievement('week1_nomiss',			{name: "HOW", description: "Beat Trump's Week on Hard with no Skill Issues (Misses)."});
		createAchievement('week1_fullstar',			{name: "I'm honestly impressed.", description: "Beat Trump's Week on Hard with all 10 stars."});
